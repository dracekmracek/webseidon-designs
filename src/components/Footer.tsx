...
const Footer: React.FC<FooterProps> = ({ className }) => {
  ...
  return (
    <footer className={cn(
      "py-10 bg-white dark:bg-ocean-darker relative overflow-hidden",
      className
    )}>
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <div className="text-2xl font-serif font-bold flex items-center">
            ...
            <p className="mt-2 text-foreground/70 max-w-md">
              Crafting modern, elegant web solutions with the power of Poseidon and the precision of expert development.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            <p className="text-foreground/70 text-sm">
              © {currentYear} Webseidon. All rights reserved.
            </p>
          </div>
        </div>
      </div>
